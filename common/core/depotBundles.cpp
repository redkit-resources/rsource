...
Bool CDepotBundles::LoadMetadataStore()
{
	...
	// If censored Arabic, load the censored side-by-side metadata store
	const String storePath = rootBundlePath + ( isArabic ? TXT( "metadata.censored.store" ) :  TXT( "metadata.store" ) );
