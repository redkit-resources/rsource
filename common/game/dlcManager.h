...
public:
	...
	void Scan( EScanType scanType = EScanType::Normal );
...
private:
	...
	virtual void OnPackageAvailable( RuntimePackageID packageID, Bool isOnDiscPackage ) override;
