...
void CCommonGame::OnGameplaySystemsGameStart( const CGameInfo& info )
{
	...
	m_dlcManager->Scan( CDLCManager::EScanType::Hotload );
	PopulateDlcInGameConfigGroupWithVars();
...
void CCommonGame::funcVisitWeibo(CScriptStackFrame& stack, void* result)
{
	FINISH_PARAMETERS;

	#ifdef RED_PLATFORM_WINPC
	ShellExecuteW(NULL, L"open", L"https://weibo.com/cdprojektred", NULL, NULL, SW_SHOWNORMAL);
	#endif
}
