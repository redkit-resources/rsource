...
Bool CUserProfileManagerOrbis::HandleOutOfDiskSpaceError( Int32 errorCode, const SceSaveDataDirName* dirName, Uint64 requiredBlocks )
{
	...
	{
		if ( false == InitCommonDialogParams( param, dirName ) )
			return false;
...
Bool CUserProfileManagerOrbis::InitCommonDialogParams( SceSaveDataDialogParam &param, const SceSaveDataDirName* dirName )
{
