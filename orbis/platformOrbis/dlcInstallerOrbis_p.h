...
SceNpServiceLabel GetServiceLabelFromCommandline( const Char* paramName, SceNpServiceLabel defaultValue )
{
	SceNpServiceLabel serviceLabel = defaultValue;
...
SceNpServiceLabel GetTrophyServiceLabel()
{
	static SceNpServiceLabel serviceLabel = -1;

	if( serviceLabel == -1 )
	{
		serviceLabel = GetServiceLabelFromCommandline( TXT( "-ps4TrophyServiceLabel" ), 0 );
	}
...
SceNpServiceLabel GetDLCServiceLabel()
{
	...
	if( serviceLabel == -1 )
	{
		serviceLabel = GetServiceLabelFromCommandline( TXT( "-ps4ServiceLabel" ), -1 );
	}
