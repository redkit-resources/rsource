		...
		{		
			for ( auto& world : m_worlds )
			{
				...
				if( areaNameEnum )
				{
					...
					manager->AddAreaMapPin( areaType, world->m_worldMapPinX, world->m_worldMapPinY, world->m_worldMapPath, CName( TXT( "content4" ) ), world->m_worldMapLoactionNameStringKey , world->m_worldMapLoactionDescriptionStringKey );
				}
			}
		}
	}
