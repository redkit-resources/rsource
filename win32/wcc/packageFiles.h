...
struct SPackageGameFiles
{
	...
	TDynArray< String >										m_onDiscDLCFiles;		//!< any files under a DLC folder
	TDynArray< String >										m_streamingCacheFiles;	//!< #hack: any streaming.cache file. Need to put on disc layer1 on PS4.
};
...
struct SPackageFiles
{
	...
	TDynArray< String >										m_ep1Files;
	TDynArray< String >										m_ep2Files;
};
