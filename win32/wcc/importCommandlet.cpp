...
bool CImportCommandlet::Execute( const CommandletOptions& options )
{
	...
	if(options.GetSingleOptionValue(TXT("texturegroup"), customParam ) )
	{
		importOptions.m_params = reinterpret_cast< IImporter::ImportOptions::ImportParams* >( &customParam );
	}
#endif
...
void CImportCommandlet::PrintHelp() const
{
	...
	LOG_WCC( TXT( "  -texturegroup=nameofgroup	- (Optional) Name of texture group when importing texture") );

#ifdef WCC_LITE
	LOG_WCC( TXT( "" ) );
	LOG_WCC( TXT( "Supported texture group names:" ) );
	LOG_WCC( TXT( "	BillboardAtlas" ) );
	LOG_WCC( TXT( "	CharacterDiffuse" ) );
	LOG_WCC( TXT( "	CharacterDiffuseWithAlpha" ) );
	LOG_WCC( TXT( "	CharacterEmissive" ) );
	LOG_WCC( TXT( "	CharacterNormal" ) );
	LOG_WCC( TXT( "	CharacterNormalHQ" ) );
	LOG_WCC( TXT( "	CharacterNormalmapGloss" ) );
	LOG_WCC( TXT( "	Default" ) );
	LOG_WCC( TXT( "	DetailNormalMap" ) );
	LOG_WCC( TXT( "	DiffuseNoMips" ) );
	LOG_WCC( TXT( "	Flares" ) );
	LOG_WCC( TXT( "	FoliageDiffuse" ) );
	LOG_WCC( TXT( "	Font" ) );
	LOG_WCC( TXT( "	GUIWithAlpha" ) );
	LOG_WCC( TXT( "	GUIWithoutAlpha" ) );
	LOG_WCC( TXT( "	HeadDiffuse" ) );
	LOG_WCC( TXT( "	HeadDiffuseWithAlpha" ) );
	LOG_WCC( TXT( "	HeadEmissive" ) );
	LOG_WCC( TXT( "	HeadNormal" ) );
	LOG_WCC( TXT( "	HeadNormalHQ" ) );
	LOG_WCC( TXT( "	MimicDecalsNormal" ) );
	LOG_WCC( TXT( "	NormalmapGloss" ) );
	LOG_WCC( TXT( "	NormalsNoMips" ) );
	LOG_WCC( TXT( "	Particles" ) );
	LOG_WCC( TXT( "	ParticlesWithoutAlpha" ) );
	LOG_WCC( TXT( "	PostFxMap" ) );
	LOG_WCC( TXT( "	QualityColor" ) );
	LOG_WCC( TXT( "	QualityOneChannel" ) );
	LOG_WCC( TXT( "	QualityTwoChannels" ) );
	LOG_WCC( TXT( "	SpecialQuestDiffuse" ) );
	LOG_WCC( TXT( "	SpecialQuestNormal" ) );
	LOG_WCC( TXT( "	SystemNoMips" ) );
	LOG_WCC( TXT( "	TerrainDiffuse" ) );
	LOG_WCC( TXT( "	TerrainNormal" ) );
	LOG_WCC( TXT( "	WorldDiffuse" ) );
	LOG_WCC( TXT( "	WorldDiffuseWithAlpha" ) );
	LOG_WCC( TXT( "	WorldEmissive" ) );
	LOG_WCC( TXT( "	WorldNormal" ) );
	LOG_WCC( TXT( "	WorldNormalHQ" ) );
	LOG_WCC( TXT( "	WorldSpecular" ) );
#endif // WCC_LITE
