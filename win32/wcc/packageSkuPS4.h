...
struct SPackageSkuPS4 : private Red::System::NonCopyable
{
	...
	Bool							m_isGOTY;					//!< Is GOTY SKU

	SPackageSkuPS4( EPackageType packageType, const SPackageFiles& packageFiles, const SPackageLanguagesPS4& packageLanguages, Bool isGOTY )
